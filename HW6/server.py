...
dataset = {
    ...
    "7": {
        ...
        "brand": "Jo Malone",
        "name": "Red Roses",
        "image": "https://media.neimanmarcus.com/f_auto,q_auto:low,ar_4:5,c_fill,dpr_2.0,w_790/01/nm_197403_100000_m",
        "year": "2001",
...
def search():
    ...
    results = {id: perfume for id, perfume in dataset.items() 
               if query in perfume['brand'].lower() or query in perfume['name'].lower()}
